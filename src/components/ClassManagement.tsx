          ...
          return (
            ...
            >
              <div>
                ...
                <div className="text-xs text-slate-600 space-y-1.5 mt-3 bg-slate-50 p-3 rounded-xl border border-slate-100">
            ...
            <form onSubmit={handleSaveClass} className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 font-bold"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 border border-slate-300 rounded-xl font-bold text-emerald-800"
                />
              </div>
